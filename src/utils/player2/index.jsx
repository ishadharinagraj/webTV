...
import { addToFavs, removeFromFavs ,getFavourites} from "@/firebase/functions";
        ...
        {previousExists && fullscreen && (
         ...
         {fullscreenAvailable && !fullscreen && (
          <div onClick={handleAspectRatio} className="option" >
            <Image alt="placeholder" src={maximizeIcon} className="full-screen-icon" />
          </div>
        )}
        {fullscreenAvailable && fullscreen && (
          <div onClick={handleAspectRatio} className="option">
            <Image alt="placeholder" src={minimizeIcon} />
            <p>Minimize</p>
          </div>
        )}
